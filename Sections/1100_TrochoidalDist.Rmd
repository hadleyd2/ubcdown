...
Throughout this section, we assume that the center of the fixed circle is assumed to be the origin in $\R^2$. Parametric equations for trochoids in $\R^2$ take argument $t$ for the radian angle measured counter-clockwise from the positive horizontal axis to the line passing through the centers of the fixed and rolling circles. See Figure \ref{Fig:trochoid-construct} for a geometric interpretation and Figure \ref{Fig:distances-pos} and Figure \ref{Fig:distances-epi} for construction of 2 trochoids as $t$ traverses $[0, 2\pi]$.
